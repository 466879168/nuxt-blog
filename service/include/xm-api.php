...
add_action("rest_api_init", function () {
    register_rest_route("dylan-blog/v1", "/info", array("methods" => "GET", "callback" => "add_get_blog_info"));
});
...
add_action("rest_api_init", function () {
    register_rest_route("dylan-blog/v1", "/like", array("methods" => "POST", "callback" => "xm_opinion"));
});
...
add_action("rest_api_init", function () {
    register_rest_route("dylan-blog/v1", "/view-count", array("methods" => "POST", "callback" => "xm_get_view_count",));
});
...
add_action("rest_api_init", function () {
    register_rest_route("dylan-blog/v1", "/menu", array("methods" => "GET", "callback" => "xm_get_menu"));
});
...
add_action("rest_api_init", function () {
    register_rest_route("dylan-blog/v1", "/update-comment-meta", array("methods" => "POST", "callback" => "add_api_comment_metadata"));
});
...
add_action("rest_api_init", function () {
    register_rest_route("dylan-blog/v1", "/get-phrase", array("methods" => "get", "callback" => "add_api_get_phrase"));
});
...
add_action("rest_api_init", function () {
    register_rest_route("dylan-blog/v1", "/get-links", array("methods" => "get", "callback" => "add_api_get_links"));
});
