<template>
  <div class="container">
    ...
    <article class="section article">
      ...
      <div class="other-info">
        ...
        <p>
          ...
          <span class="classify" v-for="(itme,index) in detail.articleInfor.classify" :key="item.key">
            {{index === detail.articleInfor.classify.length -1 ?item.name:`${item.name}`}}
          </span>
          <span class="m-l-5">
            {{viewCount}}
          </span>
    ...
    <div class="section operation">
      <ul class="opinion">
        <li class="list" v-for="(item,index) in opinion" :key="index" @click="updateOpinion(index)">
